...
const Footer = () => {
    function sendEmail(e) {
        ...
        emailjs.sendForm('service_4do5ex8', 'template_24m4ulr', e.target, 'user_FBWeDGGAg4iQ3mRXAhcdj')
          .then((result) => {
    ...
    return (
        <div id="contact">
            ...
            <div className="footer mt-5  text-center" >
                <div class="row">
                    <div className="col-lg-4 col-sm-12  mt-4" style={{ "text-align": "left" }}>
                        <span style={{ "color": "white" }}>   < FaPhone id="footIcon" />{"      "}{"      "}062 299 6061</span> <br></br>  <br></br>
                        <span style={{ "color": "white" }}>   < FaEnvelopeOpenText id="footIcon" /> {"      "}{"      "}sgadcenter@gmail.com</span><br></br> <br></br>
